...
async def main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard = [
        [InlineKeyboardButton("Найти фильм по жанру",
                              callback_data='search_genre')],
        [InlineKeyboardButton(
            "Случайный фильм", callback_data='random_movie')],
        [InlineKeyboardButton("Подобрать похожий фильм",
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Кнопка "Случайный фильм"
        ...
        keyboard = [
            [InlineKeyboardButton(
                "Попробуем еще", callback_data='random_movie')],
...
async def main():
    ...
    app.add_handler(MessageHandler(
        filters.TEXT & ~filters.COMMAND, handle_user_input, block=True))
