...
while True:
    ...
    for movie in movies:
        ...
        ganr = movie.find(
            'a',
            class_='base-movie-main-info_link__YwtP1'
        ).find(
            'span',
            class_='desktop-list-main-info_truncatedText__IMQRP'
        )
        ...
        data = movie.find(
            ...
            'span',
            class_='desktop-list-main-info_secondaryText__M_aus'
        )
        ...
        # Ссылка на фильм
        link = 'https://www.kinopoisk.ru' + movie.find(
            'div',
            class_='styles_main__Y8zDm styles_mainWithBeforeSlot__JnO7X'
        ).find(
            'a',
            class_='base-movie-main-info_link__YwtP1'
        ).get('href')
